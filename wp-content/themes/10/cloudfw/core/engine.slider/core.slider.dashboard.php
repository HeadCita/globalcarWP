        ...
        <div class="content">
            ...
            <div style="float:right; margin-left:20px;">
                ...
                <span id="createnew-toggle">
              	<a href="#" title="<?php _e('Import Slider','cloudfw'); ?>" width="m" rel="mb_import_slider" class="small-button small-green cloudfw-help"><span><?php _e('Import','cloudfw'); ?></span></a>
                <a href="#" title="<?php _e('Create New Slider','cloudfw'); ?>" width="m" rel="mb_create_slider" class="small-button small-brown cloudfw-help">
