<?php
	...
	<ul id="cloudfw-main-slider-sorting" class="slider_items cloudfw-ui-list slider_ajax">';
		...
		echo '
			<div class="module">
				<div class="thereisno">'.__('There is no any slider','cloudfw').'. <a class="cloudfw-help" rel="mb_create_slider" width="m" title="'.__('Create New Slider','cloudfw').'" href="javascript:;"><span>'.__('Create New One','cloudfw').'</span></a></div>         
				<div class="clear"></div>
			</div>
		';      
