		...
		array(
			...
			'prepend_head'	=>	'
						<div style="float:right; margin-left:20px;">
								<a href="javascript:;" title="'. __('Import','cloudfw') .'" width="m" rel="mb_import_slider" class="small-button small-green cloudfw-help">
									<span>'. __('Import','cloudfw') .'</span>
								</a>
								<a href="javascript:;" title="'. __('Create A New Slider','cloudfw') .'" width="m" rel="mb_create_slider" class="small-button small-brown cloudfw-help">
