...
<a href="javascript:void(0);" class="right-navigation cloudfw-help" id="skin-search" rel="mb_search_skin" width="m" title="<?php _e('Search Visual Element','cloudfw'); ?>"><span class="cloudfw-tooltip" title="<?php _e('Search Visual Elements (CTRL/CMD +F)','cloudfw'); ?>"><?php _e('Search Visual Element','cloudfw'); ?></span></a>
...
<?php	
	...
	echo '<div class="module"><div class="thereisno">'.__('There is no any visual set to edit','cloudfw').'. <a class="cloudfw-help" rel="mb_create_skin" width="m" title="'.__('Create New One','cloudfw').'" href="javascript:;"><span>'.__('Create New One','cloudfw').'</span></a></div></div>';
