...
return $scheme = array(
	...
	array(
		'type'		=>	'module',
		'condition' =>	isset($vars['arrows']) && $vars['arrows'] === true,
		'title'		=>	__('Enable navigation arrows?','cloudfw'),
		'data'		=>	array(

			## Element
			array(
				'type'		=>	'onoff',
				'id'		=>	$that->get_field_name('arrows', 'FALSE'),
				'value'		=>	$that->get_value('arrows', 'FALSE'),
			), // #### element: 0
	...
	array(
		'type'		=>	'module',
		'condition' =>	isset($vars['disable_on_mobile']) && $vars['disable_on_mobile'] === true,
		'title'		=>	__('Disable carousel on mobile?','cloudfw'),
		'data'		=>	array(

			## Element
			array(
				'type'		=>	'onoff',
				'id'		=>	$that->get_field_name('disable_on_mobile', 'FALSE'),
				'value'		=>	$that->get_value('disable_on_mobile', 'FALSE'),
			), // #### element: 0
