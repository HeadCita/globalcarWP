...
?>
	...
	<aside id="primary-sidebars" class="sidebar-area widget-area <?php echo $class; ?> custom-widget-<?php echo $custom_sidebar;?>">
...
?>
	...
	<aside id="primary-sidebars" class="sidebar-area widget-area primary-sidebars <?php echo $class; ?>">
