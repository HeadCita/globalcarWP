		...
		echo '
			...
			foreach ($slider_data as $slider_id => $slider){
				...
				echo $slider["slider_url"] ? 
					 '<a href="'.cloudfw_get_page_link($slider["slider_url"]).'"><img src="'.$slider_img.'" '._if($html_caption_id, 'data-title="#'.$html_caption_id.'" ').'alt=""/></a>':
					 '<img src="'.$slider_img.'" '._if($html_caption_id, 'data-title="#'.$html_caption_id.'" ').'alt=""/>';
