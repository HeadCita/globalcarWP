...
return array(
		...
		array(
			'type'      =>  'module',
			'title'     =>  __('Disable Links?','cloudfw'),
			'data'      =>  array(
				array(
					'type'      =>  'onoff',
		...
		array(
			'type'      =>  'module',
			'title'     =>  __('Enable Lightbox Links?','cloudfw'),
			'data'      =>  array(
				array(
					'type'      =>  'onoff',
		...
		array(
			'type'		=> 'module',
			'title'		=> __('Hover Button Color','cloudfw'),
			'data'		=> array(
		...
		array(
			'type'		=> 'module',
			'title'		=> __('Hover Button Icon','cloudfw'),
			'data'		=> array(
		...
		array(
			'type'      =>  'module',
			'title'     =>  __('Random Sorting','cloudfw'),
			'data'      =>  array(
				array(
					'type'      =>  'onoff',
