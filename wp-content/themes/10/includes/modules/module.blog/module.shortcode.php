			...
			return array(
				...
				'script'	=> array(
					...
					'attributes' =>	array(
						...
						'category'			=> array( 'e' => 'blog_filter_category', 'array' => false ),
						'tag'				=> array( 'e' => 'blog_filter_tag', 'array' => false ),
						'author'			=> array( 'e' => 'blog_filter_author', 'array' => false ),
						...
						'paged_var'       	=> array( 'e' => 'blog_pagination_qs' ),
						'offset'  	     	=> array( 'e' => 'blog_offset' ),

						'title_element'     => array( 'e' => 'blog_title_size', 'onoff' => true ),
						'title_align'    	=> array( 'e' => 'blog_title_align', 'onoff' => true ),

						'sticky_posts' 		=> array( 'e' => 'blog_post_allow_sticky', 'onoff' => true ),
						...
						'meta_sharrre' 		=> array( 'e' => 'blog_meta_sharrre', 'onoff' => true ),
					...
					'if' =>	array(
						...
						array(
							...
							'targets' => array(
								...
								array('a tag', '#blog_filter_tag'),
								array('an author', '#blog_filter_author'),
							)
						),
				...
				'data'		=>	array(
					...
					array(
						...
						'data'		=> array(
							...
							array(
								'type'		=>	'module',
								'title'		=>	__('Post Offset','cloudfw'),
								'data'		=>	array(
									array(
										'type'		=>	'text',
										'id'		=>	'blog_offset',
										'value'		=>	$this->get_value('blog_offset'),
										'width'		=>  100,
									)
								)
							...
							array(
								'type'		=>	'group',
								'related'	=>	'blogLayoutOptions blogLayoutOptions-Standard blogLayoutOptions-Grid-Default blogLayoutOptions-Grid-Masonry blogLayoutOptions-Mini blogLayoutOptions-Mini-Carousel',
								'data'		=>	array(
									...
									array(
										...
										'data'		=>	array(
											array(
												'type'		=>	'text',
												'id'		=>	'blog_pagination_qs',
												'value'		=>	$this->get_value('blog_pagination_qs'),
												'width'		=>	150,
											)
										)
							...
							array(
								'type'		=> 'module',
								'related'	=>	'blogLayoutOptions blogLayoutOptions-Mini-Carousel blogLayoutOptions-Grid-Carousel',
								'title'		=> __('Enable Auto-Rotate?','cloudfw'),
								'data'		=> array(
									...
									array(
										'type'		=>	'onoff',
										'id'		=>	'auto_rotate',
										'value'		=>	$this->get_value('auto_rotate', 'FALSE'),
									), // #### element: 0
					...
					array(
						...
						'data'		=> array(
								...
								'data'		=> array(
									...
									array(
										...
										'source'	=>	array(
											...
											'a tag' 		    => __('Get by a tag','cloudfw'),
											'an author' 	    => __('Get by an author','cloudfw'),
										)
									), // #### element: 0
							...
							array(
								...
								'data'		=>	array(
									...
									array(
										'type'		=>	'select',
										'id'		=>	'blog_filter_tag',
										'value'		=>	$this->get_value('blog_filter_tag'),
										'main_class'=>  'input input_250',
										'ui'		=>	true,
										'source'	=>	array(
											'type'		=>	'function',
											'function'	=>	'cloudfw_admin_loop_terms',
											'vars'		=>	array('post_tag', __('- Select a tag -','cloudfw'))
										)
									), // #### element: 0
							...
							array(
								...
								'related'	=>	'blogSources',
								'hidden'	=>	true,
								'title'		=>	__('Authors','cloudfw'),
								'data'		=>	array(

									## Element
									array(
										'type'		=>	'select',
										'id'		=>	'blog_filter_author',
										'value'		=>	$this->get_value('blog_filter_author'),
										'main_class'=>  'input input_250',
										'ui'		=>	true,
										'multiple'	=>	true,
										'brackets'	=>	true,
										'source'	=>	array(
											'type'		=>	'function',
											'function'	=>	'cloudfw_admin_loop_authors',
										)
									), // #### element: 0
							...
							array(
								'type'		=>	'module',
								'title'		=>	__('Allow sticky posts?','cloudfw'),
								'data'		=>	array(
									array(
										'type'		=>	'onoff',
										'id'		=>	'blog_post_allow_sticky',
										'value'		=>	$this->get_value('blog_post_allow_sticky', true),
									)
								)
					...
					array(
						...
						'data'		=> array(
							...
							array(
								'type'		=>	'module',
								'title'		=>	__('Sharing Service','cloudfw'),
								'data'		=>	array(
									array(
										'type'		=>	'onoff',
										'id'		=>	'blog_meta_sharrre',
										'value'		=>	$this->get_value('blog_meta_sharrre', 'FALSE'),
									)
								)
							),
...
class CloudFw_Widget_Blog_List extends CloudFw_Widgets {
	...
	function scheme( $data = array() ) {
		...
		$scheme['data'] = array(
			...
			array(
				'type'		=> 'module',
				'title'		=> __('Image Aspect Ratio','cloudfw'),
				'data'		=> array(
			...
			array(
				'type'		=>	'module',
				'title'		=>	__('Show Read More Button','cloudfw'),
				'data'		=>	array(
					array(
						'type'		=>	'onoff',
