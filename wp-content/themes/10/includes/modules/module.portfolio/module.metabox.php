        ...
        'data'  => array(
            ...
            array(
                ...
                'data'      =>  array(
                    ...
                    array(
                        ...
                        'source'    =>  array(
                            'goto'      => __('Classic: Go to the post page or custom URL', 'cloudfw'),
            ...
            array(
                ...
                'data'      =>  array(
                    ...
                    array(
                        ...
                        'desc'      => __('(optional) it\'s full size of featured image by default', 'cloudfw'),
                        'hide_input'=> true,
                        'removable' => true,
                        'library'   => true,
                   ), // #### element: 0
            ...
            array(
                ...
                'data'      =>  array(
                    ...
                    array(
                        'type'      =>  'select',
                        'id'        =>  PFIX.'_port_target',
                        'value'     =>  get_post_meta($post_id, PFIX.'_port_target', true),
                        'source'    =>  array(
            ...
            array(
                'type'      =>  'module',
                'title'     =>  __('Enable no-follow link?','cloudfw'),
                'data'      =>  array(
                    ## Element
                    array(
                        'type'      =>  'select',
                        'id'        =>  PFIX.'_port_nofollow',
                        'value'     =>  get_post_meta($post_id, PFIX.'_port_nofollow', true),
                        'source'    =>  array(
                            'NULL'      =>  __('Default','cloudfw'),
                            'yes'       =>  __('Yes','cloudfw'),
                            'no'        =>  __('No','cloudfw'),
            ...
            array(
                'type'      =>  'module',
                'title'     =>  __('Thumbnail Hover Button Color','cloudfw'),
                'data'      =>  array(
                    ...
                    array(
                        ...
                        'id'        =>  PFIX.'_port_default_button_color',
                        'value'     =>  get_post_meta($post_id, PFIX.'_port_default_button_color', true),
                        'source'    =>  array(
                            'type'      =>  'function',
