			...
			<form action="<?php echo $myaccount_page_url; ?>" method="post" class="ui-row">
				...
				<div class="form-elements">
					<div class="ui-row row">
						...
						<div class="">
							<div class="control-group">
								<div class="pull-right"><a href="<?php echo $myaccount_page_url; ?>#lost_password" class=""><?php _e( 'Lost Password', 'woocommerce' ); ?></a></div>
				...
				<div class="clearfix">
					...
					<div class="ui--block">
						<button type="submit" class="btn btn-primary btn-block" name="login" style="margin-bottom: 12px;" value="<?php _e( 'Login', 'woocommerce' ); ?>" ><?php _e( 'Login', 'woocommerce' ); ?></button>
					</div>
					...
					?>
						<div class="ui--block">
							<a href="<?php echo $myaccount_page_url; ?>#register" class="btn btn-secondary btn-block muted"><?php _e( 'Register', 'woocommerce' ); ?></a>
						</div>
					<?php endif; ?>
...
<ul id="widget--login-woocommerce" class="ui--widget ui--custom-menu opt--on-hover unstyled-all <?php echo cloudfw_visible( $device ); ?>">
		<?php if ( ! is_user_logged_in() ) { ?>
			<li>
				<a href="<?php echo get_permalink( $myaccount_page_id ); ?>" class="ui--gradient ui--gradient-grey on--hover hover" data-target="ui--side-login-widget"><?php _e('Login','woocommerce'); ?></a>
			</li>
		<?php } else {
