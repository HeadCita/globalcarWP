...
function cloudfw_metaboxes( $key = NULL, $post_id = -1 ){
	...
	$meta_boxes[cloudfw_id_for_sequence( $metaboxes, 15 )] = array(
		...
		'data'  => array(
			...
			array(
				'type'      =>  'module',
				'title'     =>  __('Revolution Sliders','cloudfw'),
				'data'      =>  array(
			...
			array(
				'type'      =>  'module',
				'condition' =>  class_exists('LS_Sliders'),
				'title'     =>  __('Layer Sliders','cloudfw'),
				'data'      =>  array(

					## Element
					array(
						'type'      =>  'select',
						'id'        =>  PFIX.'_layer_slider',
						'value'     =>  cloudfw_get_post_meta($post_id, 'layer_slider'),
						'source'    =>  array(
								'type'      =>  'function',
			...
			array(
				'type'      =>  'module',
				'title'     =>  __('Slider Position','cloudfw'),
				'data'      =>  array(

					## Element
					array(
						'type'      =>  'select',
						'id'        =>  PFIX.'_rev_slider_position',
						'value'     =>  cloudfw_get_post_meta($post_id, 'rev_slider_position'),
						'source'    =>  array(
							'NULL'          =>  'After the header',
							'before_header' =>  'Before the header'
						),
						'width'     =>  230
					), // #### element: 0
	...
	$meta_boxes[cloudfw_id_for_sequence( $metaboxes, 20 )] = array(
		...
		'data'  => array(
			...
			array(
				'type'      => 'mini-section',
				'title'     => __('Page Settings','cloudfw'),
				'data'      => array(

					array(
						'type'      => 'module',
						'conditions' => get_post_type() == 'page',
						'title'     => __('Allow comments for this page?','cloudfw'),
						'data'      => array(
					...
					array(
						'type'      => 'module',
						'title'     => __('Header Overlapping for this page?','cloudfw'),
						'data'      => array(

							## Element
							array(
								'type'      =>  'select',
								'id'        =>  PFIX.'_spec_overlapping',
								'value'     =>  cloudfw_get_post_meta($post_id, 'spec_overlapping'),
								'source'    =>  array(
					...
					array(
						'type'      => 'module',
						'title'     => __('Header Overlapping Layout','cloudfw'),
						'data'      => array(

							## Element
							array(
								'type'      =>  'select',
								'id'        =>  PFIX.'_spec_overlapping_layout',
								'value'     =>  cloudfw_get_post_meta($post_id, 'spec_overlapping_layout'),
								'source'    =>  array(
									'NULL'          => __('Default', 'cloudfw'),
									'enable'        => __('Move the header over the content area', 'cloudfw'),
								),
								'ui'        =>  true,
								'width'     =>  400,
							)
	...
	$meta_boxes[cloudfw_id_for_sequence( $metaboxes, 40 )] = array(
		...
		'data'  => array(
			...
			array(
				'type'      =>  'module',
				'title'     =>  __('Primary Sidebar','cloudfw'),
				'data'      =>  array(
			...
			array(
				'type'      =>  'module',
				'title'     =>  __('Secondary Sidebar','cloudfw'),
				'data'      =>  array(

					## Element
					array(
						'type'      =>  'select',
						'id'        =>  PFIX.'_custom_sidebar_2',
						'value'     =>  get_post_meta($post_id, PFIX.'_custom_sidebar_2', true),
						'source'    =>  array(
								'type'      =>  'function',
								'function'  =>  'cloudfw_admin_loop_custom_sidebars'
						),
