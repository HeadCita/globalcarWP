	...
	'data'			=>	array(
		...
		array(
			...
			'data'		=>	array(
				...
				array(
					'type'		=>	'mini-section',
					'title'		=>	__('Top Bar Widgets on Hover','cloudfw'),				
					'data'		=>	array(
								...
								array(
									...
									'data'		=>	array(
										...
										array(
											'type'		=>	'gradient',
											'title'		=>	__('Background-Color','cloudfw'),
											'id'		=>	cloudfw_sanitize('topbar_widgets_background_hover','gradient'),
											'value'		=>	$data['topbar_widgets_background_hover']['gradient'],
										),
										array(
											'type'		=>	'bg-set',
											'id'		=>	'topbar_widgets_background_hover',
											'id:pattern'=>	'topbar_widgets_background_hover',
											'value'		=>	$data,
											'attachment'=>	false
										)
						...
						array(
							...
							'data'		=>	array(
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Color','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_background_hover_text','color'),
									'value'		=>	$data['topbar_widgets_background_hover_text']['color'],
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Text Shadow','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_background_hover_text','text-shadow color'),
									'value'		=>	$data['topbar_widgets_background_hover_text']['text-shadow']['color'],
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Shadow Direction','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_background_hover_text','text-shadow direction'),
									'value'		=>	$data['topbar_widgets_background_hover_text']['text-shadow']['direction'],
									'source'	=>	array(
										'-1'		=>	__('Top','cloudfw'),
										'1'			=>	__('Bottom','cloudfw'),
									),
						...
						array(
							...
							'data'		=>	array( 
								...
								array(
									'type'		=>	'gradient',
									'title'		=>	__('Background Gradient','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub','gradient'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub']['gradient'],
								),
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Text Color','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub','color'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub']['color'],
								),
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Text Shadow','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub','text-shadow color'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub']['text-shadow']['color'],
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Shadow Direction','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub','text-shadow direction'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub']['text-shadow']['direction'],
									'source'	=>	array(
										'-1'		=>	__('Top','cloudfw'),
										'1'			=>	__('Bottom','cloudfw'),
									),
						...
						array(
							...
							'data'		=>	array( 
								...
								array(
									'type'		=>	'gradient',
									'title'		=>	__('Background Gradient','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub_hover','gradient'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub_hover']['gradient'],
								),
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Text Color','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub_hover','color'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub_hover']['color'],
								),
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Text Shadow','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub_hover','text-shadow color'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub_hover']['text-shadow']['color'],
								...
								array(
									...
									'style'		=>	'horizontal',
									'title'		=>	__('Shadow Direction','cloudfw'),
									'id'		=>	cloudfw_sanitize('topbar_widgets_fallout_link_active_sub_hover','text-shadow direction'),
									'value'		=>	$data['topbar_widgets_fallout_link_active_sub_hover']['text-shadow']['direction'],
									'source'	=>	array(
										'-1'		=>	__('Top','cloudfw'),
										'1'			=>	__('Bottom','cloudfw'),
									),
