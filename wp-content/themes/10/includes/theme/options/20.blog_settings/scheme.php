			...
			'data'		=>	array(
				...
				array(
					...
					'data'		=>	array(
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Fullwidth Featured Images for Blog Posts?','cloudfw'),
							'data'		=> array(

								## Element
								array(
									'type'		=>	'onoff',
									'id'		=>	cloudfw_sanitize( PFIX.'_blog fit_blog_media' ),
									'value'		=>	cloudfw_get_option( 'blog',  'fit_blog_media' ),
									'response'	=>	'ID',
									'hide_input'=>	true,
								)
			...
			'data'		=>	array(
				...
				array(
					...
					'data'		=>	array(
						...
						array(
							'type'      => 'module',
							'title'     => __('Featured Image Aspect Ratio','cloudfw'),
							'data'      => array(

								array(
									'type'		=>	'select',
									'id'		=>	cloudfw_sanitize( PFIX.'_blog_single image_ratio' ),
									'value'		=>	cloudfw_get_option( 'blog_single',  'image_ratio' ),
									'source'	=>	array(
										'type' 		=> 'function',
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Display Featured Media on Single Blog Pages?','cloudfw'),
							'data'		=> array(
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Display Post Title on Single Blog Pages?','cloudfw'),
							'data'		=> array(
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Title Element on Single Blog Pages','cloudfw'),
							'data'		=> array(
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Display Post Title before Post Media?','cloudfw'),
							'data'		=> array(

								## Element
								array(
									'type'      =>  'onoff',
									'id'		=>	cloudfw_sanitize( PFIX.'_blog_single title_before_media' ),
									'value'		=>	cloudfw_get_option( 'blog_single',  'title_before_media' ),
							   ), // #### element: 0
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Custom code before post title','cloudfw'),
							'data'		=> array(

								array(
									'type'      =>  'textarea',
									'id'		=>	cloudfw_sanitize( PFIX.'_blog_single custom_content_before_title' ),
									'value'		=>	cloudfw_get_option( 'blog_single',  'custom_content_before_title' ),
									'_class'    =>  'input textarea_400px_2line code tab-textfields tabtext',
									'wrap'      =>  'off',
								), // #### element: 0
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Custom code after post title','cloudfw'),
							'data'		=> array(

								array(
									'type'      =>  'textarea',
									'id'		=>	cloudfw_sanitize( PFIX.'_blog_single custom_content_after_title' ),
									'value'		=>	cloudfw_get_option( 'blog_single',  'custom_content_after_title' ),
									'_class'    =>  'input textarea_400px_2line code tab-textfields tabtext',
									'wrap'      =>  'off',
								), // #### element: 0
