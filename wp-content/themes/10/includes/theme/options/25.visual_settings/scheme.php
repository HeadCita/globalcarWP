				...
				5	=> array(
					...
					'prepend_head'	=>	'
								<div style="float:right; margin-left:20px;">
										<a href="javascript:void(0);" title="'. __('Import','cloudfw') .'" width="m" rel="mb_import_skin" class="small-button small-green cloudfw-help">
											<span>'. __('Import','cloudfw') .'</span>
										</a>
										<a href="#" title="'. __('Create A New Set','cloudfw') .'" width="m" rel="mb_create_skin" class="small-button small-brown cloudfw-help">
						...
						5	=> array(
							...
							'data'		=>	array(
									...
									array(
										...
										'no_result'	=>  '<div class="thereisno">'.__('There is no any visual set','cloudfw').'. <a class="cloudfw-help" rel="mb_create_skin" width="m" title="'.esc_attr(__('Create New One','cloudfw')).'" href="javascript:;"><span>'.__('Create New One','cloudfw').'</span></a></div>',
										'prepend_no_result' => '',
										'append_no_result' => '',
										'class'	=>  ' ',
									), // #### element: 0
					...
					'data'		=>	array(
						...
						array(
							...
							'data'      => array(
								...
								array(
									'type'      =>  'select',
									'id'		=>	cloudfw_sanitize(PFIX.'_section_default'),
									'value'		=>	cloudfw_get_option('section_default'),
									'source'    =>  array(
										'type'          => 'function',
