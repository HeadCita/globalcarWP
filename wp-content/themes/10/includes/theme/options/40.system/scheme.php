...
$scheme[ cloudfw_id_for_sequence( $scheme, $number ) ] = array(
	...
	'data'	=> array(
		...
		array(
			'type'		=>	'vertical_tabs',
			'tab_id'	=>	'system_status',
			'tab_title'	=>	__('System Status','cloudfw'),
			'form'		=>	array(
				'enable'	=> false,
			),
			'data'		=>	array(
				...
				array(
					'type'      =>  'container',
					'title'     =>  __('System Status','cloudfw'),
					'footer'    =>  false,
					'data'      =>  array(
					...
					'data'		=>	array(
						...
						array(
							...
							'data'		=>	array(
								...
								array(
									'type'		=>	'select',
									'id'		=>	cloudfw_sanitize(PFIX.'_who_can_see framework'),
									'value'		=>	$_opt[PFIX.'_who_can_see']['framework'],
						...
						array(
							'type'		=>	'module',
							'title'		=>	__('User capability for Slider Manager Page','cloudfw'),
							'data'		=>	array(
								array(
									'type'		=>	'text',
									'id'		=>	cloudfw_sanitize(PFIX.'_caps slider_manager'),
									'value'		=>	cloudfw_get_option( 'caps', 'slider_manager' ),
								), // #### element: 0
							)
						),
