...
function cloudfw_load_css(){
	...
	wp_register_style ('theme-child-frontend-extensions', CHILD_TMP_URL . 'extensions.css', NULL, $version);
	...
	wp_register_style ('theme-child-custom', CHILD_TMP_URL . 'custom.css', NULL, $version);
	...
	if ( $is_child_theme && file_exists( get_stylesheet_directory().'/extensions.css' ) ) {
		wp_enqueue_style ('theme-child-frontend-extensions');
	} elseif ( file_exists( TMP_CSS_PATH.'extensions.css' ) ) {
	...
	if ( cloudfw_woocommerce() ) {
		...
		} elseif ( file_exists( TMP_CSS_PATH.'woocommerce.css' ) ) {
	...
	if ( cloudfw_bbpress() ) {
		...
		} elseif ( file_exists( TMP_CSS_PATH.'bbpress.css' ) ) {
	...
	if ( $is_child_theme && file_exists( get_stylesheet_directory().'/custom.css' ) ) {
		wp_enqueue_style('theme-child-custom');
	} elseif ( file_exists( TMP_CSS_PATH.'custom.css' ) ) {
...
function cloudfw_load_javascripts(){
	...
	/** Core Scripts */
	wp_register_script ('theme-common', TMP_JS . 'common.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-modernizr', TMP_JS . 'modernizr-2.6.2-respond-1.1.0.min.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-noconflict', TMP_JS . 'noconflict.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-cufon', TMP_JS . 'cufon.js', array( 'jquery' ), $version, true);
	//wp_register_script ('theme-webfont', TMP_ADMIN.'/js/webfont.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-extensions', TMP_JS . 'extensions.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-retina', TMP_JS . 'retina.js', array( 'jquery' ), $version, true);

	/** Scripts */
	wp_register_script ('theme-woocommerce', TMP_JS . 'woocommerce.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-mousewheel', TMP_JS . 'jquery.mousewheel.min.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-touchSwipe', TMP_JS . 'jquery.touchSwipe.min.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-prettyphoto', TMP_JS . 'jquery.prettyPhoto.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-flexslider', TMP_JS . 'jquery.flexslider.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-waypoints', TMP_JS . 'waypoints.min.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-waypoints-sticky', TMP_JS . 'waypoints-sticky.js', array('theme-waypoints'), $version, true);
	wp_register_script ('theme-viewport', TMP_JS . 'jquery.viewport.mini.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-isotope', TMP_JS . 'jquery.isotope.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-masonry', TMP_JS . 'jquery.masonry.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-packery', TMP_JS . 'packery.pkgd.min.js', array( 'jquery' ), $version, true);
	wp_register_script ('theme-queryloader2', TMP_JS . 'queryloader2.js', array( 'jquery' ), $version, false);
	wp_register_script ('theme-smoothscroll', TMP_JS . 'jquery.smoothscroll.js', array( 'jquery' ), $version, true);
