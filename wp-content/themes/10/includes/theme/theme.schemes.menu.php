			...
			$scheme = array_merge( $scheme, array(
					array(
						...
						'data'		=>	array(
							...
							array(
								'type'      =>  'module',
								'title'     =>  __('Sub Menu Direction in Sticy Mode','cloudfw'),
								'data'      =>  array(
									## Element
									array(
										'type'      =>  'select',
					...
					array(
						...
						'data'		=>	array(
							...
							array(
								'type'      =>  'module',
								'title'     =>  __('Logical Condition(Login)','cloudfw'),
								'data'      =>  array(
									...
									array(
										...
										'source'	=>	array(
											'NULL'		=>	'',
											'show'		=>	__('Show','cloudfw'),
											'hide'		=>	__('Hide','cloudfw'),
										),
										'width'		=> 180
									), // #### element: 0
									...
									array(
										...
										'source'	=>	array(
											'NULL'		=>	'',
											'is_logged_in'		=>	__('If user logged in','cloudfw'),
											'is_not_logged_in'	=>	__('If user not logged in','cloudfw'),
										),
										'width'		=> 180
									), // #### element: 0
					...
					array(
						...
						'data'		=>	array(
							...
							array(
								'type'      =>  'module',
								'title'     =>  __('Logical Condition(User Roles)','cloudfw'),
								'data'      =>  array(
