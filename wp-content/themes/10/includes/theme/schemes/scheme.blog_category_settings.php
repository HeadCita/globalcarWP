			...
			'data'      =>
				array(
					...
					'data'      =>  array(
							...
							'data'      =>  array(
								...
								array(
									...
									'source'    =>  array(
										...
										'vars'      =>  array('category', __('Select category','cloudfw'), '%s', true)
									),
									'reset'     =>  '',
									'width'     =>  300,
									'brackets'  =>  true
							...
							'data'		=> array(
								...
								array(
									...
									'data'		=>	array(
										array(
											'type'		=>	'select',
											'id'		=>	cloudfw_sanitize( PFIX.'_category_options meta_sharrre' ),
											'value'		=>	cloudfw_get_option( 'category_options',  'meta_sharrre' ),
											'source'	=>	array(
												'true'		=>	__('Show','cloudfw'),
												'false'		=>	__('Hide','cloudfw'),
											),
						...
						array(
							'type'		=> 'mini-section',
							'title'		=> __('Additional Contents','cloudfw'),
							'data'		=> array(

								array(
									'type'      => 'module',
									'title'     => __('Content Before Posts List','cloudfw'),
									'data'      => array(

										## Element
										array(
											'type'      =>  'textarea',
											'id'        =>  cloudfw_sanitize(PFIX.'_category_options before_content'),
											'value'     =>  cloudfw_get_option('category_options', 'before_content'),
											'reset'     =>  '',
											'width'     =>  400,
											'line'      =>  2,
											'brackets'  =>  true
								...
								array(
									'type'      => 'module',
									'title'     => __('Content After Posts List','cloudfw'),
									'data'      => array(

										## Element
										array(
											'type'      =>  'textarea',
											'id'        =>  cloudfw_sanitize(PFIX.'_category_options after_content'),
											'value'     =>  cloudfw_get_option('category_options', 'after_content'),
											'reset'     =>  '',
											'width'     =>  400,
											'line'      =>  2,
											'brackets'  =>  true
