...
cloudfw_add_typo_setting( $map, 'body', 'body, #bbpress-forums', array( 'font-family' => 'Helvetica, Arial, sans-serif',  'font-size' => '14' ));
...
cloudfw_add_typo_setting( $map, 'sidebar_texts', '#page-content .sidebar-area' );
cloudfw_add_typo_setting( $map, 'sidebar_widgets_title', '#page-content .sidebar-area .sidebar-widget-title', array(), array(), array('font-family', 'font-size', 'font-weight', 'line-height', 'letter-spacing') );
cloudfw_add_typo_setting( $map, 'sidebar_widgets_title_strong', '#page-content .sidebar-area .sidebar-widget-title strong' );
