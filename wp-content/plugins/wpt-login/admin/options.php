...
function cloudfw_module_custom_login( $map ) {
    $map  -> option	 ( 'custom_login' )
          ...
          -> sub  	 ( 'remember_me' )
          -> sub  	 ( 'show_register_on_topbar', 'FALSE' )
			...
			'data'		=>	array(
					...
					'data'			=>	array(
						...
						array(
							...
							'data'		=>	array(
								...
								array(
									'type'		=> 'module',
									'title'		=>	__('Show register button on the top bar widget?','cloudfw'),
									'data'		=> array(

										## Element
										array(
											'type'		=>	'onoff',
											'id'		=>	cloudfw_sanitize( PFIX.'_custom_login show_register_on_topbar' ),
											'value'		=>	cloudfw_get_option( 'custom_login',  'show_register_on_topbar' ),
										)
				...
				array(
					...
					'data'			=>	array(
						array(
							'type'		=> 'module',
							'title'		=>	__('"Remember Me" Setting','cloudfw'),
							'data'		=> array(

								## Element
								array(
									'type'		=>	'select',
									'id'		=>	cloudfw_sanitize( PFIX.'_custom_login remember_me' ),
									'value'		=>	cloudfw_get_option( 'custom_login',  'remember_me' ),
									'source'	=>	array(
										'NULL'     	=>	__('Unchecked by default','cloudfw'),
										'checked'   =>	__('Checked by default','cloudfw'),
									),
									'width'		=>	200,
								)
				...
				array(
					...
					'data'			=>	array(
						...
						array(
							'type'		=> 'module',
							'title'		=>	__('Use WooCommerce\'s registration functions, if the plugin is installed','cloudfw'),
							'data'		=> array(

								## Element
								array(
									'type'		=>	'onoff',
									'id'		=>	cloudfw_sanitize( PFIX.'_custom_register use_wc_functions' ),
									'value'		=>	cloudfw_get_option( 'custom_register',  'use_wc_functions' ),
								)
