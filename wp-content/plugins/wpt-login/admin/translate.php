...
To reset your password, visit the following address: %reset_url%','cloudfw');
	...
	$map  -> option	 ( 'texts' )
		  ...
		  -> sub     ( 'custom_login.widget.form.edit_profile', __('Edit Profile','cloudfw') )
		  ...
		  -> sub     ( 'custom_login.widget.messages.check_mail', __('Check your e-mail for the confirmation link.','cloudfw') )
          ...
          -> sub  	 ( 'custom_login.widget.email_templates.reset_title', __('[%s] Password Reset','cloudfw') )
...
function cloudfw_module_custom_login_translate_wpml_registers( $map ) {
	...
	cloudfw_translate_register( 'custom_login.widget.form.edit_profile' );
	...
	cloudfw_translate_register( 'custom_login.widget.messages.check_mail' );
	...
	cloudfw_translate_register( 'custom_login.widget.email_templates.reset_title' );
						...
						array(
							...
							'vars'		=>	array(
								array(
									...
									'custom_login.widget.form.edit_profile',
								)
							)
						),
						...
						array(
							...
							'vars'		=>	array(
								array(
									...
									'custom_login.widget.messages.check_mail',
				...
				array(
					...
					'data'			=>	array(
						...
						array(
							...
							'vars'		=>	array(
								array(
		  							'custom_login.widget.email_templates.reset_title' => __('Subject for Reset Password Emails','cloudfw'),
