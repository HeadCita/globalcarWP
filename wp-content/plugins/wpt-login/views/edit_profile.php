				...
				<div class="form-elements">
					...
					<div class="custom-login-form-actions clearfix">
						<?php if ( $level !== 'message' ) { ?>
							...
							<p>
								<button type="submit" class="ui--animation btn btn-primary" name="wpt_edit_profile_submit" value="<?php echo esc_attr(cloudfw_translate( 'custom_login.widget.form.edit_profile' )); ?>" ><?php echo cloudfw_translate( 'custom_login.widget.form.edit_profile' ); ?></button>
							</p>
